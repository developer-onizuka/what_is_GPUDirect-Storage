...
First of all, a device driver will create the target Physical Address to copy from BAR to Host memory through the Virutal Address and will queue it on the FIFO of the descriptor. So, it is very important to let the DMA Engine know the Virtual Address before DMA operation.<br>
