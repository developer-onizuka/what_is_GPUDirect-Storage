...
I guess GDS also has a plan to use the Controller Memory Buffer (CMB) which NVMe controller exposes for the performance improvement on p2pdma in the future. But GDS is actually using the BAR space on GPU card for P2P DMA.
